...
<head>
    ...
    <!-- icons-from-fontawesome v4 -->
    <link rel="stylesheet" href="{{ asset('fonts/fontawesome-all.min.css')}}">
    <!-- custome css -->
    <link rel="stylesheet" href="{{ asset('css/frontendcss/style.css')}}">
</head>
