...
<section class="academi-section ">
    <div class="container d-flex h-100">
        <div class="row  align-self-center">
            <div>
                <h3 class=" message-heading text-white">Publication / Blue is Darkness</h3>
            </div>
        </div>
</section>
<section class="publication pt-5 pb-5">
    <div class="container p-2 rounded new-shadow">
        <div class="row align-items-center">
            <div class="col-md-5">
                <div class="p-3 mb-5 d-flex align-items-center hr ">
            ...
            <div class="col-md-6">
                <div>
                    <h3 class="message-heading-color">Author(s)</h3>
                    ...
                    <hr>
                    <h3 class="message-heading-color">Description</h3>
