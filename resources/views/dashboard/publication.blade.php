                    ...
                    <div class="col-md-12 grid-margin">
                        <div class="row">
                            <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                <h3 class="font-weight-bold">Welcome CADT</h3>
                                <h6 class="font-weight-normal mb-0">A place where your Innovation Idea become reality
                                    </span></h6>
                            </div>
                                ...
                                <div class="d-flex flex-row align-items-center">
                                    ...
                                    <div class="ml-auto mb-3">
                                        <button class="btn btn-danger btn-sm" data-toggle="modal"
                                            data-target="#exampleModalLong"><i class="mdi mdi-plus-circle mr-2"> Add
                                                new publication</i></button>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#"> <i class="mdi mdi-book"> PDF FILE</i> <a>
                                                </td>
                                                <td>
                                                    19:00 AM
                                                </td>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="container-fluid">
                        <form>
                            <h4 class="text-center mb-4"> Publication </h4>
                            <hr>
